import{_ as i,c as a,a4 as l,o as n}from"./chunks/framework.BvVMNBiX.js";const c=JSON.parse('{"title":"NODE 模块化","description":"","frontmatter":{},"headers":[],"relativePath":"node/node/modules.md","filePath":"node/node/modules.md"}'),e={name:"node/node/modules.md"};function p(t,s,h,k,o,r){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="node-模块化" tabindex="-1">NODE 模块化 <a class="header-anchor" href="#node-模块化" aria-label="Permalink to &quot;NODE 模块化&quot;">​</a></h1><h2 id="模块作用域" tabindex="-1">模块作用域 <a class="header-anchor" href="#模块作用域" aria-label="Permalink to &quot;模块作用域&quot;">​</a></h2><div class="tip custom-block github-alert"><p class="custom-block-title">TIP</p><p>每个文件就是一个模块，每个模块中的成员是私有的，只有向外暴露时，其他模块才能使用</p></div><p> </p><h2 id="commonjs-规范" tabindex="-1">CommonJS 规范 <a class="header-anchor" href="#commonjs-规范" aria-label="Permalink to &quot;CommonJS 规范&quot;">​</a></h2><div class="tip custom-block github-alert"><p class="custom-block-title">TIP</p><p></p><ol><li><p>概念：CommonJS，简称 CMJ，这是一个<strong>社区</strong>规范，出现时间较早，目前仅 node 环境支持；</p></li><li><p>实现：node 天生支持 CommonJS 模块化标准</p></li><li><p>规定：</p></li></ol><blockquote><ol><li>node 中的每个 js 文件都是一个 CMJ 模块，通过 node 命令运行的模块，叫做入口模块；</li><li>模块中的所有全局定义的变量、函数，都不会污染到其他模块；</li><li>模块可以暴露（导出）一些内容给其他模块使用，需要暴露什么内容，就在模块中给<code>module.exports</code>赋值；</li><li>一个模块可以导入其他模块，使用函数<code>require(&quot;要导入的模块路径&quot;)</code>即可完成，该函数返回目标模块的导出结果；</li><li>一个模块在被导入时会运行一次，然后它的导出结果会被 node 缓存起来，后续对该模块导入时，不会重新运行，直接使用缓存结果</li></ol><p>注意：</p><blockquote><ol><li>导入模块时，可以省略<code>.js</code>；</li><li>导入模块时，必须以<code>./</code>或<code>../</code>开头</li></ol></blockquote></blockquote></div><p> </p><h2 id="导入与导出" tabindex="-1">导入与导出 <a class="header-anchor" href="#导入与导出" aria-label="Permalink to &quot;导入与导出&quot;">​</a></h2><div class="tip custom-block github-alert"><p class="custom-block-title">TIP</p><p></p><h4 id="_1-暴露成员对象" tabindex="-1">1. 暴露成员对象 <a class="header-anchor" href="#_1-暴露成员对象" aria-label="Permalink to &quot;1. 暴露成员对象&quot;">​</a></h4><blockquote><ul><li>module 对象中的 exports 对象可以向外暴露自身模块的成员</li></ul></blockquote><p> </p><h4 id="_2-导出方式" tabindex="-1">2. 导出方式 <a class="header-anchor" href="#_2-导出方式" aria-label="Permalink to &quot;2. 导出方式&quot;">​</a></h4><blockquote><h6 id="_1-exports" tabindex="-1">1. <code>exports</code> <a class="header-anchor" href="#_1-exports" aria-label="Permalink to &quot;1. \`exports\`&quot;">​</a></h6><ol><li>使用 exports 导出：</li></ol><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// myModule.js</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 在这种情况下，最终导出的只有 module.exports 中的函数，而 exports.name 将被忽略</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div></blockquote></blockquote><p> </p><h4 id="_3-导入模块的基本流程" tabindex="-1">3. 导入模块的基本流程 <a class="header-anchor" href="#_3-导入模块的基本流程" aria-label="Permalink to &quot;3. 导入模块的基本流程&quot;">​</a></h4><blockquote><ol><li>将相对路径转为绝对路径，定位目标文件；</li><li>缓存检测；</li><li>读取目标文件代码；</li><li>包裹为一个函数并自执行（通过 argumentscallee.toString()查看自执行函数）；</li><li>缓存模块的值；</li><li>返回 module.exports 的值</li></ol></blockquote><p> </p><h4 id="_4-导入注意点" tabindex="-1">4. 导入注意点 <a class="header-anchor" href="#_4-导入注意点" aria-label="Permalink to &quot;4. 导入注意点&quot;">​</a></h4><blockquote><ol><li>导入其他类型文件时，会以 js 文件进行处理；</li><li>如果导入的路径是个文件夹：</li></ol><blockquote><ol><li>首先会去找该文件夹下的 package.json 文件中 main 属性对应的文件，如果存在则导入，否则报错</li><li>如果 package.json 文件不存在，或者 main 属性不存在，则会尝试导入该文件夹下的 index.js 和 index.json，如果没有找到则报错</li></ol></blockquote></blockquote></div><p> </p><h2 id="三大模块" tabindex="-1">三大模块 <a class="header-anchor" href="#三大模块" aria-label="Permalink to &quot;三大模块&quot;">​</a></h2><div class="tip custom-block github-alert"><p class="custom-block-title">TIP</p><p></p><h4 id="_1-核心模块" tabindex="-1">1. 核心模块 <a class="header-anchor" href="#_1-核心模块" aria-label="Permalink to &quot;1. 核心模块&quot;">​</a></h4><blockquote><ol><li>node 自带的模块，安装引入即可使用；</li><li>导入模块：<code>const 变量名 = require(&#39;核心模块名&#39;)</code></li></ol></blockquote><h4 id="_2-自定义模块" tabindex="-1">2. 自定义模块 <a class="header-anchor" href="#_2-自定义模块" aria-label="Permalink to &quot;2. 自定义模块&quot;">​</a></h4><blockquote><ol><li>自定义模块导入：<code>const 变量名 = require(&#39;文件路径&#39;)</code></li></ol><blockquote><ol><li>不能与核心模块同名；</li><li>.js 后缀可以省略</li></ol></blockquote><ol start="2"><li>自定义模块导出：通过 module.exports 关键字按需导出</li></ol></blockquote><h4 id="_3-第三方模块" tabindex="-1">3. 第三方模块 <a class="header-anchor" href="#_3-第三方模块" aria-label="Permalink to &quot;3. 第三方模块&quot;">​</a></h4><blockquote><ol><li>定义：其他人写的模块</li><li>导入模块：<code>const 变量名 = require(&#39;核心模块名&#39;)</code></li></ol></blockquote></div>`,12)]))}const E=i(e,[["render",p]]);export{c as __pageData,E as default};
